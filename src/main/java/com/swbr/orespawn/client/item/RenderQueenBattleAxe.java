...
/**
 * Port of {@code danger.orespawn.RenderQueenBattleAxe} (RenderQueenBattleAxe.java:9-74), the
 * in-hand renderer of the Queen Scale Battle Axe ({@code queenbattleaxesmall}). Same poses and
 * scale as {@link RenderBattleAxe}, different model and texture.
 */
public class RenderQueenBattleAxe extends BigWeaponRenderer<QueenBattleAxeModel> {

    /** {@code new ResourceLocation("orespawn", "QueenBattleAxetexture.png")} (:72), moved by the
     *  asset generator to {@code textures/entity/} (manifest texture_map). */
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(OreSpawn.MOD_ID, "textures/entity/queenbattleaxetexture.png");

    /** {@code glRotatef(180, 1, 0.25, 0)} (:63). */
    ...
    @Override
    protected QueenBattleAxeModel bake(EntityModelSet models) {
        return new QueenBattleAxeModel(models.bakeLayer(QueenBattleAxeModel.LAYER)); // :15
    }
